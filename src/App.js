...
class App extends React.Component {
  ...
  processBoard() {
      ...
      if (firstMark != 2) {
        ...
        if (marks.length == 3) {
          document.querySelector("#message1").innerHTML =
            String.fromCharCode(symbolsMap[marks[0]][1]) + " WIN!";
          document.querySelector("#message1").style.display = "block";
          pattern.forEach(index => {
            var id = index + "-" + firstMark;
            document.getElementById(id).parentNode.style.background = "#bfd9c5";
          });
    ...
    if (!this.state.boardState.includes(2) && !won) {
      document.querySelector("#message2").innerHTML = "GAME OVER! DRAW!";
    ...
    return (
      <div>
        <div class="container jumbotron" id="container">
          ...
          <p>{String.fromCharCode(symbolsMap[this.state.turn][1])} TURN</p>
